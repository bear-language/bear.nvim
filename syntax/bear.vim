...
syntax match bearSpecial /@same_type\|@type_to_str\|@has_contract\|@static_assert\|@defined\|@inferable_as\|@err\|@warn\|@note\|@help\|@alignof\|@sizeof\|@id\|@type_id\|@members_of\|@statics_of\|@scoped_id/
